...
const terminalCommands = [
  { cmd: '$ whoami', output: 'Pinnam Devendra Gupta' },
  { cmd: '$ cat role.txt', output: 'Software Engineer | MERN Stack Developer' },
  { cmd: '$ ls skills/', output: 'react/ node/ mongodb/ python/ java/' },
  { cmd: '$ git status', output: 'On branch main - Ready to build something amazing!' },
];
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-3 bg-card/80 border-b border-border">
              ...
              <span className="text-sm text-muted-foreground ml-2 font-mono">devendra@portfolio:~</span>
            </div>
