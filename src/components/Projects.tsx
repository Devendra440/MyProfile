...
const projects = [
  {
    ...
    description: 'A machine learning application that classifies news content as real or fake using Python and scikit-learn. Trained on a comprehensive dataset with title, text, subject, and date fields.',
    highlights: [
      'Increased model accuracy by 32% compared to earlier versions',
      'Detects fraudulent news within 60 seconds',
      'User-friendly interface for quick verification',
    ],
    technologies: ['Python', 'scikit-learn', 'Streamlit', 'Machine Learning', 'NLP'],
    liveLink: 'https://fakenewsdetectionsystem-bvgp9ms2nlbshdqnlsjzky.streamlit.app/',
    gradient: 'from-cyan-500 to-blue-600',
  },
  {
    title: 'Sleeping Disorder Analysis',
    subtitle: 'Data Analytics Project',
    period: 'July – Sep 2024',
    description: 'Comprehensive data analytics project performing preprocessing, feature extraction, and correlation analysis to support predictive disorder detection.',
    highlights: [
      'Achieved 95% prediction accuracy',
      'Users reported 60-70% improvement in sleep structure',
      'Utilized Python, Excel, and visualization libraries',
    ],
    technologies: ['Python', 'Data Analytics', 'Excel', 'Visualization', 'Pandas'],
    githubLink: 'https://github.com/Devendra440/Sleeping-Disorder-Analysis-Data-Analytics-Project/tree/main/sleeping_disorder_prediction',
